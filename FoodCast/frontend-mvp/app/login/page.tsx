...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const backendRole = selectedRole === "donor" ? "store" : 
                         selectedRole === "recipient" ? "shelter" : 
                         selectedRole === "driver" ? "student" : "admin"
      ...
      if (data.success) {
        ...
        if (data.code === 'USER_NOT_FOUND') {
          ...
          alert(`${data.message}\n\nExpected role: ${data.expectedRole}`)
          // Clear password field and reset role selection
          setPassword("")
