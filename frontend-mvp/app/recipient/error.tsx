...
export default function RecipientError({
  ...
  useEffect(() => {
    console.error('Recipient page error:', error)
  }, [error])
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">Recipient Dashboard Error</CardTitle>
          <CardDescription>
            There was an error loading the recipient dashboard.
          </CardDescription>
        </CardHeader>
